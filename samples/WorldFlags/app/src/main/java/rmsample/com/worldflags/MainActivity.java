...
public class MainActivity extends AppCompatActivity {
    ...
    private void showFlagOfCountryName(final String countryName){
        ...
        if (flagLinearLayout!= null){
            linearLayout.removeView(flagLinearLayout);
        }
        if(map.keySet().contains(countryName)){
...
//            @Override
//            public void onClick(View view) {
//                Toast.makeText(MainActivity.this,"Dynamic button tapped!",Toast.LENGTH_SHORT).show();
//            }
//        });
//        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.linearLayoutId);
